...
const projects = [
  {
    ...
    description: "Brief description of what this project does. Explain the problem it solves and key features.",
      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {projects.map((project, index) => (
            <div
              key={project.title}
              className={`group glass-card rounded-2xl overflow-hidden hover-lift ${isVisible ? 'animate-slide-up' : 'opacity-0'}`}
