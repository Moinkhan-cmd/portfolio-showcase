  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 relative z-20">
        {/* Single-column card */}
        <motion.div
          className="relative max-w-3xl mx-auto rounded-3xl border border-primary/15 bg-card/40 backdrop-blur-xl overflow-hidden"
        ...
        >
          ...
          <div className="relative p-7 sm:p-9">
            ...
            {/* Divider */}
            <div className="my-7 h-px w-full bg-gradient-to-r from-transparent via-primary/15 to-transparent" />
            ...
            {/* Bottom row */}
            <div className="mt-8 pt-6 border-t border-primary/10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-sm text-muted-foreground">
