...
You can deploy this as a static site on platforms like Vercel or Netlify.

- Build: `npm run build`
- Output: `dist/`

This repo includes platform config files ([vercel.json](vercel.json) and [netlify.toml](netlify.toml)).
